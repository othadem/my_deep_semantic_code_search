...
class CodeSearchJavaDataset(data.Dataset):
    ...
    def __init__(self, data_dir, f_name, name_len, f_api, api_len, f_tokens, tok_len, f_descs=None, desc_len=None):
...
class CodeSearchPythonDataSet(data.Dataset):
    def __init__(self, data_dir, f_name, name_len, f_api, api_len, f_tokens, tok_len, f_descs=None, desc_len=None, random_state=42):
...
if __name__ == '__main__':
    ...
    valid_set = CodeSearchPythonDataSet(VALID_FILE)
